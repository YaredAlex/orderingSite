...
export const Steps =()=>{
    return(
        ...
        <Stack direction="horizontal" className="steps justify-content-evenly p-2 flex-sm-wrap gap-2">
           <div className="steps-card border borer-dark rounded shadow p-2">
               <div>
                <img src="img/delivery.png" alt="dilivery"/>
               </div>
               <h4>Fast delivery</h4>
            ...
            <div className="steps-card border borer-dark rounded p-2">
               <div>
                <img src="img/chef1.png" alt="chef"/>
               </div>
               <h4>Highly</h4>
